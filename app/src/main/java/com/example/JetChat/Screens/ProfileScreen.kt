...
import com.example.JetChat.CommonDivider
import com.example.JetChat.CommonImage
    ...
    if (inProgress) {
        ...
        Column(
            ...
            ProfileContent(
                ...
                onBack = {navigateTo(navController, route = DestinationScreen.ChatList.route) },
                onLogout = {
                    vm.logout()
...
fun ProfileContent(
    ...
    Column(
        ...
        Row(
            ...
            Row(
                modifier = Modifier.padding(0.dp,365.dp,0.dp,0.dp)
            ){
